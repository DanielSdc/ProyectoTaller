    ...
    if (user) {
      ...
      querySnapshot.forEach((doc) => {
        ...
        table.row.add([
          ...
          data.fincontrato,
          data.contratoPdf ? `<a href="${data.contratoPdf}" target="_blank" class="btn btn-sm btn-primary d-flex justify-content-center align-items-center"><i class="fas fa-file-pdf fa-2x" aria-hidden="true"></i></a>` : 'No disponible',
    ...
    if (user) {
      try {
        ...
        table.row.add([
          ...
          pagado, // Nuevo campo
          fincontrato,
          contratoPdfUrl ? `<a href="${contratoPdfUrl}" target="_blank" class="btn btn-sm btn-primary d-flex justify-content-center align-items-center"><i class="fas fa-file-pdf fa-2x" aria-hidden="true"></i></a>` : 'No disponible',
          `<div class="d-flex justify-content-center align-items-center">
